...
begin
     ...
     //StatusBar1.Panels[1].Text:= 'Usuário: André Mendes';
end;

procedure Tfrm_principal.iposdeCertificado1Click(Sender: TObject);
begin
     // se o formulário não estiver instanciado
     if not Assigned(f_filtroTiposCertificados) then
     begin
          // instanciando o formulário
          f_filtroTiposCertificados:= Tf_filtroTiposCertificados.create(application);
     end
     else begin
          f_filtroTiposCertificados.Show;
     end;
end;
